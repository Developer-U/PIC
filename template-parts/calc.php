                        ...
                        <div class="calc__checks">
                            ...
                            <div class="calc__boxes calc-items row">
                                <fieldset class="calc-items__box1">
                                    ...
                                    <input id="radio-1"  type="radio" name="first" value="100" checked class="price" data-name="ПВХ, MSD Premium (белый)">
                                    <label for="radio-1">MSD Premium (белый)</label>

                                    <input id="radio-2" type="radio" name="first" value="120" class="price" data-name="ПВХ, MSD Premium (цветной)">
                                    <label for="radio-2">MSD Premium (цветной)</label>

                                    <input id="radio-3" type="radio" name="first" value="130" class="price" data-name="ПВХ, Pongs (белый)">
                                    <label for="radio-3">Pongs (белый)</label>

                                    <input id="radio-4"  type="radio" name="first" value="140" class="price" data-name="ПВХ, Pongs (цветной)">
                                    <label for="radio-4">Pongs (цветной)</label>

                                    <input id="radio-5" type="radio" name="first" value="150" class="price" data-name="ПВХ, Фотопечать">
                                ...
                                <fieldset class="calc-items__box2">
                                    ...
                                    <input id="radio-6" type="radio" name="first" value="190" class="price" data-name="Ткань, Descor">
                                    <label for="radio-6">Descor</label>

                                    <input id="radio-7" type="radio" name="first" value="200" class="price" data-name="Ткань, Фотопечать">
                                ...
                                <fieldset class="calc-items__box3">
                                    ...
                                    <input id="radio-8" type="radio" name="first" value="260" class="price" data-name="Сатиновые, MSD Premium (белый)">
                                    <label for="radio-8">MSD Premium (белый)</label>

                                    <input id="radio-9"  type="radio" name="first" value="210" class="price" data-name="Сатиновые, MSD Premium (цветной)">
                                    <label for="radio-9">MSD Premium (цветной)</label>

                                    <input id="radio-10" type="radio" name="first" value="180" class="price" data-name="Сатиновые, Pongs (белый)">
                                    <label for="radio-10">Pongs (белый)</label>

                                    <input id="radio-11"type="radio" name="first" value="190" class="price" data-name="Сатиновые, Pongs (цветной)">
...
<script>
    window.addEventListener('DOMContentLoaded', function(){
        ...
        // Открытие попапа Заказать потолок из калькулятора

        var zakazField = document.querySelector('.js-zakazPopup');
        var zakazFieldOpen = document.querySelector('.calc-result__btn'); 
        var zakazClose = document.querySelector('.js-zakazClose');   
        var flag = false;

        document.querySelector('.calc-result__btn').addEventListener('click', function(e){   
            e.preventDefault();   
            if(!flag) {
            fadeIn(zakazField, 300, 'flex');
                    
            document.querySelector('body').classList.add('closed');

            } else {
            fadeOut(zakazField, 300);
            
            document.querySelector('body').classList.remove('closed');
            }  
            
            zakazClose.addEventListener('click', function(){
                fadeOut(zakazField, 300);
        ...
        document.querySelector('#zakazForm').addEventListener( 'wpcf7mailsent', function( event ) {
